export const translations = {
    en: {
        ...
        bento: {
            ...
            item2: {
                title: "NexaStore",
                description: "Luxury tech e-commerce demo. Product catalog, cart persistence, and checkout flow built with Next.js App Router + Zustand.",
            },
            evidenceItem: {
                title: "Evidence Layer",
                description: "Proof-first page: Lighthouse budgets, SLA metrics, RFC scoring, and Playwright checks—linked to real code.",
            },
            item3: {
                title: "ISO 13485 QMS",
        ...
        nexastorePage: {
            hero: {
                ...
                timeline: "Timeline",
                coreTech: "Core Tech",
                coreTechValue: "Next.js App Router, Zustand, Tailwind",
            },
            problem: {
                title: "The Problem",
                description: "I needed a realistic e-commerce demo that feels production-grade (catalog, PDP, cart, checkout) to showcase component architecture, state management, and UX—without over-engineering a backend.",
            },
            solution: {
                title: "The Solution",
                description: "Built a Next.js App Router storefront with server-rendered catalog filtering, a persisted Zustand cart, and an end-to-end checkout confirmation flow (simulated payment).",
                globalState: "Global State Management",
                globalStateDesc: "Zustand + persistence keeps the cart across sessions and avoids prop drilling or Context re-render pitfalls.",
                realtime: "Search & Filtering",
                realtimeDesc: "Category + query-string filtering keeps URLs shareable and server-rendered for fast navigation.",
                conversion: "Checkout UX",
                conversionDesc: "Fast add-to-cart, cart drawer, and a clear checkout summary + confirmation state.",
            },
    ...
    es: {
        ...
        bento: {
            ...
            item2: {
                title: "NexaStore",
                description: "Demo de e-commerce premium. Catálogo de productos, carrito persistente y checkout construido con Next.js App Router + Zustand.",
            },
            evidenceItem: {
                title: "Capa de Evidencia",
                description: "Página de prueba: presupuestos Lighthouse, métricas SLA, scoring RFC y checks Playwright—con links a código real.",
            },
            item3: {
                title: "SGC ISO 13485",
        ...
        nexastorePage: {
            ...
            problem: {
                title: "El Problema",
                description: "Necesitaba un demo de e-commerce que se sintiera real (catálogo, PDP, carrito, checkout) para mostrar arquitectura de componentes, manejo de estado y UX—sin sobre-ingenierizar un backend.",
            },
            solution: {
                title: "La Solución",
                description: "Construí una tienda con Next.js App Router: catálogo con filtros server-rendered, carrito persistente con Zustand, y un flujo end-to-end de checkout con confirmación (pago simulado).",
                globalState: "Gestión de Estado Global",
                globalStateDesc: "Zustand + persistencia mantiene el carrito entre sesiones y evita prop drilling o re-renders innecesarios.",
                realtime: "Búsqueda y Filtros",
                realtimeDesc: "Filtros por categoría y query params para URLs compartibles y navegación rápida.",
                conversion: "UX de Checkout",
                conversionDesc: "Add-to-cart rápido, cart drawer, resumen de compra y estado de confirmación.",
            },
